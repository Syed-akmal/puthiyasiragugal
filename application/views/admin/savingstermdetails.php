<?php
$account_id = $customerloaninfo->id;
$savingsId = $customerloaninfo->savingId;
?>
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Savings Term Details</h1>
...
<div class="card shadow mb-4">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-4"><h5> <b>Amount Paid : </b> <?php echo ($customerloaninfo->total_amount); ?> </h5></div>
        </div>
    </div>
</div>
            ...
            columns: [{
                ...
                // },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        var editUrl = "<?php echo base_url('Customer/editsavingstermdetails/'); ?>" + row.id;
                        var deleteUrl = "<?php echo base_url('Customer/deletesavingstermdetails/'); ?>" + row.id;
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- Example: -->
                <form role="form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" id="addloan" enctype="multipart/form-data" action="<?php echo base_url() ?>Customer/savingsterm" method="post" role="form">
                    <div class="form-group">
                        <label for="term">Term:</label>
                        <input type="number" class="form-control" id="term" name="term" placeholder="Enter Term" required>
                        <input type="hidden" class="form-control" id="account_id" name="account_id" value="<?= $account_id ?>" >
                        <input type="hidden" class="form-control" id="savings_id" name="savings_id" value="<?= $savingsId ?>" >
                    </div>
                    <div class="form-group">
