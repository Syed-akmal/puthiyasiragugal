...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Edit Savings Term Details</h1>
</div>
...
<div class="card shadow mb-4">
    <div class="card-body">
        <form role="form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" id="editterm" enctype="multipart/form-data" action="<?php echo base_url() ?>Customer/editsavingsterm" method="post" role="form">
